...
import HostelLocationDropdown from "./HostelLocationDropdown";
import { HomeContext } from "./index";

const HostelLocation = (props) => {
    ...
    <Fragment>
      <div className="flex justify-between font-medium">
        <div
          onClick={(e) =>
            dispatch({
              type: "locationListDropdown",
              payload: !data.locationListDropdown,
            })
          }
          className={`flex items-center space-x-1 cursor-pointer ${
            data.locationListDropdown ? "text-yellow-700" : ""
          }`}
        >
