...
export const CheckoutComponent = (props) => {
  ...
  useEffect(() => {
    fetchData(cartListHostel, dispatch);
      ...
      <section className="mx-4 mt-20 md:mx-12 md:mt-32 lg:mt-24">
        ...
        <div className="flex flex-col md:flex md:space-x-2 md:flex-row">
          <div className="md:w-1/2">
            <CheckoutHostels hostels={data.cartHostel} />
          </div>
            ...
            {state.clientToken !== null ? (
              <Fragment>
                ...
                >
                  ...
                  <div className="w-full px-4 py-2 text-center text-white font-semibold cursor-pointer"
                    style={{ background: "#303031" }}>
                      COD
                  </div>
                </div>
    ...
    <Fragment>
      <div className="grid grid-cols-2 md:grid-cols-1">
        {hostels !== null && hostels.length > 0 ? (
          ...
          <div>No hostel found for checkout</div>
        )}
      </div>
    </Fragment>
  );
...
export default CheckoutHostels;
