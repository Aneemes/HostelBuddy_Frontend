  ...
  return (
    <Fragment>
      ...
      >
        ...
        <div
          onClick={(e) => history.push("/admin/dashboard/locations")}
          className={`${
            location.pathname === "/admin/dashboard/locations"
              ? "border-r-4 border-gray-800 bg-gray-100"
              : ""
          } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
        >
          ...
          <span className="hover:text-gray-800">Locations</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
          onClick={(e) => history.push("/admin/dashboard/hostels")}
          className={`${
            location.pathname === "/admin/dashboard/hostels"
              ? "border-r-4 border-gray-800 bg-gray-100"
              : ""
          } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
        >
          ...
          <span className="hover:text-gray-800">Hostel</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-gray-800">Bookings</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
